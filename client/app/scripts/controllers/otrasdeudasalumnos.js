...
(function() {
  ...
  /**
    * @ngdoc function
    * @name unuApp.controller:OtrasDeudasAlumnosCtrl
    * @description
    * # OtrasDeudasAlumnosCtrl
    * Controller of the unuApp
   */

  angular.module('unuApp').controller('OtrasDeudasAlumnosCtrl', [
'MessageFactory', '$rootScope', '$scope', 'Restangular', '$mdDialog', '$timeout', 'ngTableParams', 'LxDialogService', 'ToastMD', '$mdBottomSheet', '$state',
  function(MessageFactory, $rootScope, $scope, Restangular, $mdDialog, $timeout, ngTableParams, LxDialogService, ToastMD, $mdBottomSheet, $state) {
    ...
    $scope.UI = {
      ...
      title: 'Listado de Concepto de Otras Deudas del Alumno',
      editMode: false,
      selected: null,
      customActions:[]
    };
    var LOCAL ={
      name: 'Concepto de Otras Deudas del Alumno',
      form:'views/otrasdeudasalumnos/form.html',
      route:'otrasdeudasalumnos'
    };
    ...
    $scope.New = function New($event){
      ...
      $mdDialog.show({
        ...
        controller: 'OtrasDeudasAlumnoNewCtrl'
      });
    };
    $scope.Edit = function Edit($event){
      ...
      $mdDialog.show({
        ...
        controller: 'OtrasDeudasAlumnoEditCtrl'
      });
    };
  ...
  .controller('OtrasDeudasAlumnoNewCtrl',['$scope', 'table', 'name', 'MessageFactory', '$mdDialog', 'service', 'ToastMD', 'Restangular',
  ...
  .controller('OtrasDeudasAlumnoEditCtrl',['$scope', 'table', 'name', 'MessageFactory', 'model', 'ToastMD', '$mdDialog', 'Restangular',
