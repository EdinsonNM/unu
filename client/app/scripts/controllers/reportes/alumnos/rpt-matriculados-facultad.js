...
(function() {
   ...
   */
  angular.module('unuApp').controller('RptMatriculadosFacultadCrtl', ['$mdSidenav',
    '$q',
    'MessageFactory',
    '$rootScope',
    '$scope',
    ...
    function($mdSidenav, $q, MessageFactory, $rootScope, $scope, Restangular, $mdDialog, $timeout, NgTableParams, LxDialogService, ToastMD, $mdBottomSheet, $state) {
      $scope.UI = {
        ...
        title: 'Reporte de Matriculados por Facultad',
      };
      var LOCAL = {
        name: "Reporte de Alumnos Matriculados por Facultad",
      };
      ...
      $scope.ListAlumnos = function(){
        var service = Restangular.all('alumnos/methods/reports/matriculadosfacultad');
