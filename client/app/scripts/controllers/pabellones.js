...
(function() {
   ...
   */
  angular.module('unuApp').controller('PabellonesCtrl', function(MessageFactory, $rootScope,$scope, Restangular, $mdDialog, $timeout, ngTableParams, LxDialogService, LxNotificationService, $mdBottomSheet, $state) {
    var List, service;
